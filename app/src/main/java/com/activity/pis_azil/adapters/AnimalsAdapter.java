    ...
    public void onBindViewHolder(@NonNull AnimalViewHolder holder, int position) {
        ...
        if (animal.getImgUrl() != null && !animal.getImgUrl().isEmpty()) {
            Glide.with(context)
                    ...
                    .placeholder(R.drawable.paw) // Zamjenska slika dok se učitava
                    .error(R.drawable.fruits) // Zamjenska slika u slučaju greške
                    .into(holder.animalImage);
        } else {
            holder.animalImage.setImageResource(R.drawable.milk2); // Zamjenska slika ako imgUrl nije dostupan
        }
    }
